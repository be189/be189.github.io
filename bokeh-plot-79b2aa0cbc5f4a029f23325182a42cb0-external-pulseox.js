(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8836a4c8-2836-4472-8eb5-6e69765d9fdc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8836a4c8-2836-4472-8eb5-6e69765d9fdc' but no matching script tag was found.")
        }
