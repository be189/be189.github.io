(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("b40c1e7e-1fd4-4c27-97cd-939c5faef867");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b40c1e7e-1fd4-4c27-97cd-939c5faef867' but no matching script tag was found.")
        }
