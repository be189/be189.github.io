(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cacfb8b0-c381-412d-86b8-976742179b7d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cacfb8b0-c381-412d-86b8-976742179b7d' but no matching script tag was found.")
        }
