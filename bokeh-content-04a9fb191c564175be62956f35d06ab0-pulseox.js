(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be9c47de-2c83-4157-b008-3833a3c8d144");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be9c47de-2c83-4157-b008-3833a3c8d144' but no matching script tag was found.")
        }
