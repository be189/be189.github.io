(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("c97f9cbb-3ca8-461b-a8d0-691a8dd7160e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c97f9cbb-3ca8-461b-a8d0-691a8dd7160e' but no matching script tag was found.")
        }
