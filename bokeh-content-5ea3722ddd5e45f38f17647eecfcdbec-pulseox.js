(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("5f26035d-34f2-44ed-bbb0-a3ec7bd46d69");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5f26035d-34f2-44ed-bbb0-a3ec7bd46d69' but no matching script tag was found.")
        }
