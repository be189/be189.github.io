(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("459724cb-2782-41ac-87e6-8656d2e39eb4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '459724cb-2782-41ac-87e6-8656d2e39eb4' but no matching script tag was found.")
        }
