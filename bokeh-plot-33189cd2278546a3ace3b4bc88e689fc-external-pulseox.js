(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("598f615a-bef2-49ac-9108-3ca3814c9245");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '598f615a-bef2-49ac-9108-3ca3814c9245' but no matching script tag was found.")
        }
