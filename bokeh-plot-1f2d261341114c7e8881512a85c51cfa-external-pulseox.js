(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2602fcc0-831f-41d3-a327-6ae06da1f274");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2602fcc0-831f-41d3-a327-6ae06da1f274' but no matching script tag was found.")
        }
